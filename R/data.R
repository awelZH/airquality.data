#' Air quality monitoring data for typical pollutants within the Canton of Zürich
#'
#' Air quality monitoring data as yearly values at sites in the Canton of Zürich, Switzerland,
